## SCRIPT PARA CREAR PREREQUISITOS EN EL SISTEMA
# Primero crea la base de datos si no existe (No se ha inicializado aún Flask), el usuario administrador del sistema y carga datos a las tablas auxiliares de accidentes usando la plantilla excel cargadatos.xlsx


# Necesario para la creacion del usuario inicial
import sqlite3
...
# CREACION DE LA BD
def crea_db():
    app = create_app() # Crear la aplicación Flask para reutilizar su codigo de creacion de la BD
